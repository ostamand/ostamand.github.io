...
Finally, the training environment is shown below. Note that to speed up training twelve parallel identical environments were used. 

![overall](/assets/rcb_training.png)

The training of the agents using PPO is showed in the following clip. For more details on the hyperparameters and neural network architecture considered refer to the [github page](https://github.com/ostamand/rolling-balls) of the project.
